    ...
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" method="post" action="{{ route('obat.store') }}" autocomplete="off">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group{{ $errors->has('nama_obat') ? ' has-danger' : '' }}">
                                    ...
                                    class="form-control{{ $errors->has('nama_obat') ? ' is-invalid' : '' }}" autofocus required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group{{ $errors->has('harga_obat') ? ' has-danger' : '' }}">
                                    <input type="number" name="harga_obat" id="input_harga_obat"
                                    class="form-control{{ $errors->has('harga_obat') ? ' is-invalid' : '' }}" autofocus>
