      ...
      <div class="col-lg-6 col-md-6">
        <div class="card card-chart">
          <div class="card-header">
            <h5 class="card-category">{{ __('Hitung Umur & Cari Tahun') }}</h5>
            ...
            {{-- <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                <a class="dropdown-item" href="#">{{ __('Tahun') }}</a>
          ...
          <div class="card-body">
            <form>
              <div class="form-group">
                <div class="row">
                  <div class="col">
                    <input type="text" class="form-control" placeholder="Tahun Lahir">
                  </div>
                  <div class="col">
              ...
              <button type="submit" class="btn btn-sm btn-info">Hitung</button>
            </form>
            {{-- <div class="statistics">
              <div class="info"> --}}
                ...
                <h6 class="stats-title">{{ __('Hitung') }}</h6> --}}
              {{-- </div>
            </div> --}}
            ...
            <div class="row">
              ...
              <div class="col-4">
                <div class="stats" id="stats">
                  Tahun : 
                  <script>
                    document.getElementById('stats').appendChild(document.createTextNode(new Date().getFullYear()))
                  </script>
                </div>
              </div>
            </div>
