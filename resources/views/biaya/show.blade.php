                    ...
                    <div class="card-header">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                ...
                                <a class="btn btn-primary btn-round pull-right text-white" href="{{ route('biaya.create') }}">{{ __('Tambah Biaya') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="col-md-12">
                            {{-- <div class="row justify-content-center mb-4">
                                <a class="btn btn-primary btn-round pull-right text-white" href="{{ route('rekam.create') }}">{{ __('Cetak Biaya') }}</a>
                            </div> --}}
                                    ...
                                    <form method="post" class="form-horizontal" action="{{ route('biaya.store') }}" autocomplete="off" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group{{ $errors->has('adm') ? ' has-danger' : '' }}">
                                                    <input type="number" name="adm" id="input_adm" class="form-control{{ $errors->has('adm') ? ' is-invalid' : '' }}" autofocus>
                                        ...
                                        <div class="pl-lg-4">
                                            <div class="text-center">
                                                <button type="submit" class="btn btn-success mt-4">{{ __('Print') }}</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
