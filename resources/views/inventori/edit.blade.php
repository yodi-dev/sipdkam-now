                    ...
                    <div class="card-header mb-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('inventori.index') }}" class="btn btn-primary btn-round">{{ __('Back to list') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" class="form-horizontal" action="{{ route('inventori.update', $inventori) }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group{{ $errors->has('nama_item') ? ' has-danger' : '' }}">
                                        ...
                                        class="form-control{{ $errors->has('nama_item') ? ' is-invalid' : '' }}" value="{{ old('nama_item', $inventori->nama_item) }}" autofocus>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group{{ $errors->has('generik') ? ' has-danger' : '' }}">
                                        ...
                                        class="form-control{{ $errors->has('generik') ? ' is-invalid' : '' }}" value="{{ old('generik', $inventori->generik) }}" autofocus>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group{{ $errors->has('satuan') ? ' has-danger' : '' }}">
                                        ...
                                        class="form-control{{ $errors->has('satuan') ? ' is-invalid' : '' }}" value="{{ old('satuan', $inventori->satuan) }}" autofocus>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group{{ $errors->has('stok') ? ' has-danger' : '' }}">
                                        ...
                                        class="form-control{{ $errors->has('stok') ? ' is-invalid' : '' }}" value="{{ old('stok', $inventori->stok) }}" autofocus>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group{{ $errors->has('expired_date') ? ' has-danger' : '' }}">
                                        ...
                                        class="form-control{{ $errors->has('expired_date') ? ' is-invalid' : '' }}" value="{{ old('expired_date', $inventori->expired_date) }}" autofocus>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group{{ $errors->has('locater') ? ' has-danger' : '' }}">
                                        ...
                                        class="form-control{{ $errors->has('locater') ? ' is-invalid' : '' }}" value="{{ old('locater', $inventori->locater) }}" autofocus>
