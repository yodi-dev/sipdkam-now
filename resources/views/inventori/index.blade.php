        ...
        <div class="col-md-12" id="roles-table">
            <div class="card">
                <div class="card-header d-flex justify-content-md-end">
                    <a class="btn btn-primary btn-round text-white" href="{{ route('inventori.create') }}">{{ __('Baru') }}</a>
                    ...
                    <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> {{ $item->locater }}</td>
                                <td class="text-right">
                                    <a type="button" href="{{ route('inventori.edit',$item) }}" rel="tooltip"
                                        class="btn btn-success btn-icon btn-sm " data-original-title="" title="">
                                        <i class="now-ui-icons ui-2_settings-90"></i>
                                    </a>
                                    @can('delete', $item)
                                    <form action="{{ route('inventori.destroy', $item) }}" method="post"
