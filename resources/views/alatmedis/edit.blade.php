                    ...
                    <div class="card-header mb-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('alatmedik.index') }}" class="btn btn-primary btn-round">{{ __('Back to list') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" class="form-horizontal" action="{{ route('alatmedik.update', $alatmedik) }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group{{ $errors->has('nama') ? ' has-danger' : '' }}">
                                        ...
                                        value="{{ old('nama', $alatmedik->nama) }}" autofocus>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group{{ $errors->has('stok') ? ' has-danger' : '' }}">
                                        ...
                                        class="form-control{{ $errors->has('stok') ? ' is-invalid' : '' }}" value="{{ old('stok', $alatmedik->stok) }}" autofocus>
