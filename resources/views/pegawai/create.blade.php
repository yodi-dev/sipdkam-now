    ...
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" method="post" action="{{ route('pegawai.store') }}" autocomplete="off">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group{{ $errors->has('nama_pegawai') ? ' has-danger' : '' }}">
                                    ...
                                    class="form-control{{ $errors->has('nama_pegawai') ? ' is-invalid' : '' }}" autofocus required>
