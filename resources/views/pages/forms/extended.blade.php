      ...
      <div class="col-md-4">
        <div class="card ">
          <div class="card-header ">
            <h4 class="card-title">{{ __('Datetimepicker') }}</h4>
          </div>
          <div class="card-body ">
              ...
              <div class="col-md-6">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="checkbox" checked name="checkbox" class="bootstrap-switch" data-on-label="<i class='now-ui-icons ui-1_check'></i>" data-off-label="<i class='now-ui-icons ui-1_simple-remove'></i>" />
                    <input type="checkbox" name="checkbox" class="bootstrap-switch" data-on-label="<i class='now-ui-icons ui-1_check'></i>" data-off-label="<i class='now-ui-icons ui-1_simple-remove'></i>" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
