...
class Reseed extends Command
{
    ...
    public function handle()
    {
        ...
        File::copy(storage_path('app/public/pictures-seed/emilyz.jpg'), storage_path('app/public/pictures/emilyz.jpg'));
        File::copy(storage_path('app/public/pictures-seed/james.jpg'), storage_path('app/public/pictures/james.jpg'));
